...
2) Mapping countries in the datasets to a Python library (insert library name) that contains the official names of all countries. This process homogenized the names using abbreviations, and we dropped countries for which we lacked information.
